...
O servidor já registra conversas com NPCs e os passos do tutorial. No cliente, o HUD agora apresenta capítulo e objetivo em duas linhas, atualizando a cada avanço da interação. Isso cria uma leitura de missão semelhante a um MMORPG clássico sem tirar o jogador da exploração.
